...
namespace ObjectStorageQueueSetting
{
    ...
    extern const ObjectStorageQueueSettingsUInt32 persistent_processing_node_owner_absence_grace_seconds;
    ...
    , use_hive_partitioning((*queue_settings_)[ObjectStorageQueueSetting::use_hive_partitioning])
{
    ...
    temp_metadata = std::make_unique<ObjectStorageQueueMetadata>(
        ...
        (*queue_settings_)[ObjectStorageQueueSetting::persistent_processing_node_owner_absence_grace_seconds],
...
static const std::unordered_set<std::string_view> changeable_settings_unordered_mode{
    ...
    "persistent_processing_node_owner_absence_grace_seconds",
...
ObjectStorageQueueSettings StorageObjectStorageQueue::getSettings() const
{
    ...
    settings[ObjectStorageQueueSetting::persistent_processing_node_owner_absence_grace_seconds]
        = static_cast<UInt32>(files_metadata->getPersistentProcessingNodeOwnerAbsenceGraceSeconds());
